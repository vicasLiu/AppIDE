...
(function(){
    ...
    var Mode = function( inst ) {
        ...
        var cid = inst.componentId;
        this.setValue = function( arg ) {
            tipsData = $.extend(true, {}, tipsData, arg);
            tipsModeData[cid] = tipsData;
            tipsModeData[cid].id = inst.cid;
            tipsModeData[cid].type = "Tips";
            APPIDE.Publisher.publish( "savePlugConfig", {
                cid : cid,
                type : "Tips",
                value : tipsModeData[cid]
            }, inst );
            inst.view.refreshValue(arg);
        };
        this.setStyle = function( arg ) {
            if( tipsModeData[cid].css == undefined ) {
                tipsModeData[cid].css = {};
            }
            tipsModeData[cid].css = $.extend(true, {}, tipsModeData[cid].css, arg);
            APPIDE.Publisher.publish( "savePlugConfig", {
                cid : cid,
                type : "Tips",
                value : tipsModeData[cid]
        ...
        this.getValue = function() {
            APPIDE.Publisher.publish( "setValue", tipsModeData[cid], inst );
        };
    };
    ...
    Tips.prototype = {
        ...
        reloadCon : function() {
            var inst = this, msg = inst.tipsConfig;
            APPIDE.Publisher.publish( "loadPlugConfigFinished", msg, inst );
            this.control.getValue();
        },
